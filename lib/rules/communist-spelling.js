...
/**
 * Replaces a word within a string while preserving case
 ...
 * @private
 */
function replacePreservingCase(str, find, replace) {
...
module.exports = {
    meta: {
        ...
        fixable: "code", // Make the rule fixable
    ...
    create(context) {
        ...
        /**
         * Checks a node for rule violations and provides fixes.
            ...
            if (reported.indexOf(node) < 0) {
                ...
                findSpellings(node.name).forEach(([word, prefer]) => {
                    ...
                    context.report({
                        ...
                        fix(fixer) {
                            // Create the new identifier name with the preferred spelling
                            const newName = replacePreservingCase(
                                node.name,
                                word,
                                prefer
                            );
